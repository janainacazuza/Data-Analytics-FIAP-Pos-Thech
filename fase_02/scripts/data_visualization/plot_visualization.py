...
# Custom color palette with a slightly darker shade of blue
palette = sns.color_palette(['#023047', '#e85d04', '#0077b6', '#ff8200', '#005f87', '#ff9c33'])
...
def analysis_plots(data, features, histplot=True, barplot=False, mean=None, text_y=0.5,    
                   ...
                   nominal=False, palette=None, color='#023047', figsize=(8, 4), stat='proportion'):
    '''
    ...
    Args:
        ...
        palette (list, optional): Custom color palette. Default is None.
        color (str, optional): The default color of the plot. Default is '#023047'.
        figsize (tuple, optional): The figsize of the plot. Default is (24, 12).
        stat (str, optional): Statistic used for histogram plots. Default is 'proportion'.
    ...
    try:
        # Get number of features and rows/columns to iterate over the subplot dimensions
        num_features = len(features)
        num_rows = num_features // 3 + (num_features % 3 > 0) 
        
        fig, axes = plt.subplots(num_rows, 3, figsize=figsize)  
        palette = palette or sns.color_palette(['#023047', '#e85d04', '#0077b6', '#ff8200', '#005f87', '#ff9c33'])
        ...
        for i, feature in enumerate(features):
            ...
            if barplot:
                ...
                # Plot histplot.
                sns.histplot(data=data, x=feature, kde=kde, ax=ax, color=color, stat=stat, hue=hue)

            ax.set_title(feature)  
            ax.set_xlabel('')  
        
        # Remove unused axes if fewer features than subplots
